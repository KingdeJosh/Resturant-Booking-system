  ...
  <?php do { ?>
    <form name="form1" method="post"> 
      ...
      <tr class="danger">
        ...
        <td><input name="remove" type="hidden" value="<?php echo $row_Breakfast['Breakfast_ID']; ?>">
          <button type="submit" class="btn btn-danger">Remove Employee</button></td> 
      </tr>
  ...
  <?php do { ?>
    <form name="form1" method="post"> 
      ...
      <tr class="danger">
        ...
        <td><input name="remove1" type="hidden" value="<?php echo $row_Lunch['Lucnch_ID']; ?>">
          <button type="submit" class="btn btn-danger">Remove Employee</button></td> 
      </tr>
    ...
    <?php } while ($row_Lunch = mysql_fetch_assoc($Lunch)); ?>
      ...
      <thead> 
        <tr> <th>Breakfast ID</th> <th>Customer_ID</th> <th>Party Size</th> <th>Date</th> <th>Bill</th> <th>Comment</th></tr> </thead> 
        <tbody>
  ...
  <?php do { ?>
    <form name="form1" method="post"> 
      ...
      <tr class="danger">
        ...
        <td><input name="remove2" type="hidden" value="<?php echo $row_Dinner['Dinner_ID']; ?>">
          <button type="submit" class="btn btn-danger">Remove Employee</button></td> 
      </tr>
