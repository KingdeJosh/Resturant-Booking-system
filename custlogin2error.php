...
if (isset($_POST['Username'])) {
  ...
  $MM_redirectLoginSuccess = "welcomepage.php";
  $MM_redirectLoginFailed = "custlogin2error.php";
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                             ...
                             <li class="divider"></li>
                            <li>
                                <a href="Emplogin.php">Employees Only</a>
                            </li>
                        </ul>
                    </li>
                </ul>
            ...
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li><a href="index.php">Home</a>
                         <li><a href="custregister2.php">Sign Up</a>
                    </li>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <p>Sign in now to get special offers and events</p>
                     <div class="alert alert-danger">
                    <strong>Oh snap!</strong> Username and password is Invalid.
                </div>
                    <form ACTION="<?php echo $loginFormAction; ?>" METHOD="POST" role="form" id="Login">
                        <div class="row">
