    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Dinner Booking
                            </li>
                        </ol>
                    </div>
                </div>
               ...
               <p>Showing <?php echo ($startRow_Dinner ) ?> to <?php echo min($startRow_Dinner + $maxRows_Dinner, $totalRows_Dinner) ?> of <?php echo $totalRows_Dinner ?> Bookings</p>
               <table class="table"> 
                ...
                <?php if ($totalRows_Dinner > 0) { // Show if recordset not empty ?>
                  ...
                  </tr><?php } while ($row_Dinner = mysql_fetch_assoc($Dinner)); ?>
