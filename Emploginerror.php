...
if (isset($_POST['Username'])) {
  ...
  $MM_redirectLoginSuccess = "empindex2.php";
  $MM_redirectLoginFailed = "Emploginerror.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_localhost, $localhost);
  	
  $LoginRS__query=sprintf("SELECT Username, Password, Userlevel FROM empolyee WHERE Username=%s AND Password=%s",
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <strong>Oh snap!</strong> Username or password is Invalid.
                </div>
