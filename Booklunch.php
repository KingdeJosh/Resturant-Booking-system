...
$query_Checkspaces = sprintf("SELECT SUM(`Party_size`) FROM lunch WHERE `Date` = %s", GetSQLValueString($colname_Checkspaces, "date"));
...
mysql_select_db($database_localhost, $localhost);
$query_Recordset2 = "SELECT * FROM lunch";
                ...
                <div class="col-lg-12">
                    ...
                    <div class="intro-message">
                     ...
                     <hr class="intro-divider">
                        <form action="bookingsucc1.php"name="morning session" method="POST" id="booking">
