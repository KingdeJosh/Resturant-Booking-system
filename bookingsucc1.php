...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "morning session")) {
  $insertSQL = sprintf("INSERT INTO lunch (Customer_ID, Party_size, Adults, Children, `Date`, `Comment`, Bill) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
mysql_select_db($database_localhost, $localhost);
$query_bookmorn = sprintf("SELECT * FROM lunch WHERE `Date` = %s", GetSQLValueString($colname_bookmorn, "date"));
...
<body>
                    ...
                    <div class="intro-message">
                     ...
                     <hr class="intro-divider">
                        ...
                        <h5>Total Party Size :<?php echo $AdultChildren?></h5> 
                            <hr class="intro-divider">
                            <?php Bill::Calculatebilllunch($Adult,$Children);
                            ?>  <hr class="intro-divider">
  ...
  $colname_Checkspaces = $_POST['Date'];
                                ...
                                <input name="Bill" type="Hidden" class="form-control" id="Bill" value="<?php $billtotal= Bill::totalbilllunch($Adult,$Children); echo $billtotal ?>">
                            </li>
                            <li>
