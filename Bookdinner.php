...
$query_Checkspaces = sprintf("SELECT SUM(`Party_size`) FROM dinner WHERE `Date` = %s", GetSQLValueString($colname_Checkspaces, "date"));
...
if (isset($_POST[$MM_flag])) {
  ...
  $spacesleft = 20 - $row_Checkspaces['SUM(`Party_size`)'];
...
mysql_select_db($database_localhost, $localhost);
$query_Recordset2 = "SELECT * FROM dinner";
...
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="intro-message">
                        ...
                        <h5>Make your reservations quickly, only 
                        <?php $spacesleft = 20 - $row_Checkspaces['SUM(`Party_size`)'];
						       echo $spacesleft;
								
							   ?> Spaces Left For this session</h5>
                     <hr class="intro-divider">
                        <form action="bookingsucc2.php"name="morning session" method="POST" id="booking">
  ...
  $colname_Checkspaces = $_POST['Date'];
                                ...
                                <select class="form-control" name="Adult" id="Adult"> <option>1</option> <option>2</option> <option>3</option>  <option>4</option>  <option>5</option>  <option>6</option>  <option>7</option>  <option>8</option> <option>9</option>  <option>10</option> </select>
                            </li>
                             <li>
                                <label for="Children" >Children </label>
                                <select class="form-control" name="children" id="children"> <option>1</option> <option>2</option> <option>3</option>  <option>4</option>  <option>5</option>  <option>6</option>  <option>7</option>  <option>8</option> <option>9</option>  <option>10</option> </select>
                            </li>
                        </ul>
                        <ul class="list-inline intro-social-buttons">
                            <li>
                                <label for="name">Comment</label>  
                                <textarea  type="text" class="form-control" name="comments" id="Comments" placeholder="Kindly inform us of any of your special needs" rows="3"></textarea>
                        ...
                        <input name="customer" type="hidden" value="<?php echo $row_Index['Customer_ID']; ?>">
                          <button type="submit" class="btn btn-warning"><span class="network-name"> BOOK  </span></button>
                        </p>
                        </form>
