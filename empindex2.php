...
$customer = mysql_query($query_customer, $localhost) or die(mysql_error());
$row_customer = mysql_fetch_assoc($customer);
$totalRows_customer = mysql_num_rows($customer);

mysql_select_db($database_localhost, $localhost);
$query_employee = "SELECT * FROM empolyee";
...
mysql_select_db($database_localhost, $localhost);
$query_breakfast = "SELECT * FROM breakfast ORDER BY `Date` DESC";
...
$maxRows_Feeds = 10;
$pageNum_Feeds = 0;
if (isset($_GET['pageNum_Feeds'])) {
  $pageNum_Feeds = $_GET['pageNum_Feeds'];
}
$startRow_Feeds = $pageNum_Feeds * $maxRows_Feeds;

mysql_select_db($database_localhost, $localhost);
$query_Feeds = "SELECT * FROM feeds ORDER BY `Timestamp` DESC";
$query_limit_Feeds = sprintf("%s LIMIT %d, %d", $query_Feeds, $startRow_Feeds, $maxRows_Feeds);
$Feeds = mysql_query($query_limit_Feeds, $localhost) or die(mysql_error());
$row_Feeds = mysql_fetch_assoc($Feeds);

if (isset($_GET['totalRows_Feeds'])) {
  $totalRows_Feeds = $_GET['totalRows_Feeds'];
} else {
  $all_Feeds = mysql_query($query_Feeds);
  $totalRows_Feeds = mysql_num_rows($all_Feeds);
}
$totalPages_Feeds = ceil($totalRows_Feeds/$maxRows_Feeds)-1;

mysql_select_db($database_localhost, $localhost);
$query_Lunch = "SELECT * FROM lunch";
...
mysql_select_db($database_localhost, $localhost);
$query_Dinner = "SELECT * FROM dinner";
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo $totalRows_breakfast ?> </div>
                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo $totalRows_Lunch ?></div>
                        ...
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo $totalRows_Dinner ?> </div>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        ...
                                        <div class="huge"><?php echo $totalRows_customer ?></div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right fa-fw"></i> Afternoon Session Bookings</h3>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-clock-o fa-fw"></i> Comments Panel</h3>
                            </div>
                            <div class="panel-body">
                                <div class="list-group">
                                   
                                    
                                    <?php if ($totalRows_Feeds > 0) { // Show if recordset not empty ?>
                                      <?php do { ?> 
                                    <a href="#" class="list-group-item">
                                        <span class="badge"><?php echo $row_Feeds['Timestamp']; ?></span>
                                        <i class="fa fa-fw fa-comment"></i> <?php echo $row_Feeds['Message']; ?>
                                    </a> 
                                        <?php } while ($row_Feeds = mysql_fetch_assoc($Feeds)); ?>
                                      <?php } // Show if recordset not empty ?>
                                </div>
                                <div class="text-right">
                                    <a href="#">View All Comments <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Morning Session</h3>
                            </div>
                            <div class="panel-body">
