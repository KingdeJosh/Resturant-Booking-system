...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "update")) {
  $updateSQL = sprintf("UPDATE dinner SET Customer_ID=%s, Party_size=%s, `Date`=%s, `Comment`=%s, Empoyee_ID=%s WHERE Dinner_ID=%s",
  ...
  $updateGoTo = "UpdateDinnerBooking.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<body>
    ...
    <div id="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           <p><h1><strong>Update Dinner Bookings</strong></h1></p>  
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Update Dinner Booking
                            </li>
                        </ol>
                    </div>
                </div>
     ...
     <div class="row text-center"><div class="col-lg-12">
                <ul class="pagination">
Showing <?php echo ($startRow_Dinner + 1) ?> to <?php echo min($startRow_Dinner + $maxRows_Dinner, $totalRows_Dinner) ?> of<?php echo $totalRows_Dinner ?>
            </ul>
            </div></div>
      <thead> 
        <tr> 
           <th>Dinner ID</th> <th>Customer ID</th><th>Party Size</th><th>Date</th><th>Additional Feeds</th> 
        </tr> 
      </thead> 
      <tbody>
      <?php do { ?>
  ...
  <tr class="success">
    ...
    <td><input type="text" name="Customer_ID" class="form-control" id="Customer_ID" value="<?php echo $row_Dinner['Customer_ID']; ?>" ></td>
    <td><input type="text" name="Party_Size" class="form-control" id="Party_Size" value="<?php echo $row_Dinner['Party_size']; ?>" ></td>
    <td><input type="text" name="Date" class="form-control" id="Date" value="<?php echo $row_Dinner['Date']; ?>" ></td>
    <td><input type="text" name="comment" class="form-control" id="comment" value="<?php echo $row_Dinner['Comment']; ?>" ></td>
    <td><input name="update" type="hidden" value="<?php echo $row_Dinner['Dinner_ID']; ?>"> <input name="empupdate" type="hidden" value="<?php echo $row_Index['Employee_ID']; ?>">
      <button type="submit" class="btn btn-success">Update</button></td>
  </tr>
  <?php } // Show if recordset not empty ?>
<input type="hidden" name="MM_update" value="update">
      </form>   <?php } while ($row_Dinner = mysql_fetch_assoc($Dinner)); ?>
      </tbody> 
  </table>
  ...
  <li> <a href="<?php printf("%s?pageNum_Dinner=%d%s", $currentPage, max(0, $pageNum_Dinner - 1), $queryString_Dinner); ?>">&laquo; Previous Page</a></li>
