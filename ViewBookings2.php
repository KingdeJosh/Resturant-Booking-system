...
$totalRows_Index = "-1";
if (isset($_SESSION['MM_Username'])) {
  $totalRows_Index = $_SESSION['MM_Username'];
}
$colname_Index = "-1";
if (isset($_SESSION['MM_Username'])) {
  $colname_Index =$_SESSION['MM_Username'] ;
...
mysql_select_db($database_localhost, $localhost);
$query_lunch = "SELECT * FROM lunch ORDER BY `Date` ASC";
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Lunch Booking
                            </li>
                        </ol>
                    </div>
                </div>
               ...
               <p>Showing <?php echo ($startRow_lunch) ?> to <?php echo min($startRow_lunch + $maxRows_lunch, $totalRows_lunch) ?> of <?php echo $totalRows_lunch ?> Bookings</p>
               <table class="table"> 
                
                <thead> 
                    <tr> 
                        <th>Booking ID</th> <th>Customer ID</th>  <th>Party Size </th><th>Date</th><th>Comments</th>
                    </tr> 
                </thead> 
                <tbody>
                <?php if ($totalRows_lunch > 0) { // Show if recordset not empty ?>
                  ...
                  </tr><?php } while ($row_lunch = mysql_fetch_assoc($lunch)); ?>
